...
import { Terminal, Box, FunctionSquare, LayoutTemplate, Database, Link2, PlayCircle, BoxSelect } from 'lucide-react';

// Extracted Logic
import { extractTokenRanges } from '../lib/tokenUtils';
import { processCodeLines } from '../lib/lineUtils';
import { getNodeBorderColor, getTokenStyle } from '../lib/styleUtils';
...
const CodeCard: React.FC<CodeCardProps> = ({ node, onTokenClick, activeDependencies }) => {
