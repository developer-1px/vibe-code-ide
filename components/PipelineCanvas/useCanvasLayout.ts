...
import { LEVEL_SPACING, VERTICAL_GAP, estimateNodeHeight, getUsageIndex, hasCycle } from './utils';
...
export const useCanvasLayout = (
    ...
    const templateRootId = useMemo(() => {
        const id = `${entryFile}::TEMPLATE_ROOT`;
        return fullNodeMap.has(id) ? id : null;
