...
import type { CodeLine, CodeSegment, SegmentKind } from '@/features/Code/CodeViewer/core/types/codeLine';
import { activeLocalVariablesAtom } from '@/features/Code/FocusMode/model/atoms';
import { buildSegmentStyle } from '@/pages/shared/features/CodeViewer/core/styler/styleBuilder';
import { LocalVariableSegment } from '@/pages/shared/features/CodeViewer/ui/segments/LocalVariableSegment';
